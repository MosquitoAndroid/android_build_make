...
""" % bcb_dev)
  ...
  buildid = target_info.GetBuildProp("ro.mosquito.build.version")
  buildtype = target_info.GetBuildProp("ro.mosquito.releasetype")
  ...
  device = target_info.GetBuildProp("ro.mosquito.device")
